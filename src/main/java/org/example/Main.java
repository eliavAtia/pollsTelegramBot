...
public class Main {
    public static void main(String[] args) {
        ...
        Question question = new Question("what is your favorite food");
        question.addOption("pizza");
        question.addOption("burger");
        question.addOption("chips");
        Poll poll =new Poll();
        poll.setQuestions(List.of(question));
        jFrame.add(new PollReadyScreen(0,0,740,416,jFrame, poll,0));
